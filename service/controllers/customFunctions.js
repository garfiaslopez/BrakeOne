...
module.exports =  {
    update_stock:  (req, res, next) => {
        ...
        if (req.body.brand && req.body.quantity_percent) { // update by brand 
            ...
            objectModel.updateMany({key_id:"103.11760"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"103.15890"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"103.16140"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"103.17110"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"103.17760"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"103.18300"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"105.11080"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"105.15220"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"300.08720"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"300.09720"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"301.08660"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"301.09640"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"301.11940"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"301.12100"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"301.12110"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"301.12640"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"301.13240"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"301.15390"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"301.16500"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"301.18430"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"306.07560"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"306.13030"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"306.13040"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"306.13340"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1012"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1020"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1021"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1022"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1028"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1037"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1061"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1078"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1081"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1083"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1086"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1088"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1092"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1100"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1101"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1148"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1156"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1158"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1179"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1184"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1204"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1211"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1212"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1226"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1259"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1275"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
            objectModel.updateMany({key_id:"GCD1281"}, data, function(err, response) { if (err) { return console.log('No se pudo actualizar el producto' + response) } else { return console.log('Se actualizo correctamente el producto') } })
