        ...
        if (!isEmpty(this.state.client_id)) {
            if (this.state.products.length > 0 || this.state.services.length > 0) {
                const Sell =  {
                    ...
                    car_brand: this.state.cars.brand,
                    car_color: this.state.cars.color,
                    car_kms: this.state.cars.kms,
                    car_model: this.state.cars.model,
                    car_plates: this.state.cars.plates,
                    car_vin: this.state.cars.vin,
                    car_year: this.state.cars.year,          
