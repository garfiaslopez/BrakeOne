        ...
        if (!isEmpty(this.state.client_id)) {
            if (this.state.products.length > 0 || this.state.services.length > 0) {
                const Sell =  {
                    ...
                    car_brand: this.state.car_id.car_brand,
                    car_color: this.state.car_id.car_color,
                    car_kms: this.state.car_id.car_kms,
                    car_model: this.state.car_id.car_model,
                    car_plates: this.state.car_id.car_plates,
                    car_vin: this.state.car_id.car_vin,
                    car_year: this.state.car_id.car_year,          
