...
class CrudLayoutReceptionSell extends Component {
  state = {
    data: [],
  ...
  //Accion para abrir formulario para agregar nuevo
  onOpenSubmitForm = () => {    
    this.setState({
      opened_submit: true,
    });
  };
//Acción para cerrar formulario al Agregar nuevo
  onCloseSubmitForm = () => { 
    this.setState({
      opened_submit: false,
      error: undefined,
...
//Acciones para cerrar al consultar alguna venta, cotizacion, servicio e.t.c
  onCloseViewForm = () => {
    this.setState({
      opened_view: false,
      error: undefined,
  ...
  //Accion al dar click en boton guardar registro
  ...
  //Acción al dar clic en alguna venta, servicio e.t.c. ver sus detalles
  onView = (record) => {    
    this.setState({
  ...
  render() {
    ...
    if (this.schema) {
      if (this.state.opened_submit) {     
        //Formularios
        //Esto hace que abra los formularios para insertar por cada modelo. 
        form = (          
          <FormGenerator
...
export default CrudLayoutReceptionSell;
