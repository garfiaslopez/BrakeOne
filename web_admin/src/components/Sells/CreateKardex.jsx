...
import OrderCreatorKardex from "../../helpers/OrderCreator/OrderCreatorKardex"
...
class CreateKardex extends Component {
  ...
  constructor(props) {
    ...
    this.onErrorOrderCreatorKardex = this.onErrorOrderCreatorKardex.bind(this);
    
    this.onChangeOrderCreatorKardex = this.onChangeOrderCreatorKardex.bind(this);
  ...
  onChangeOrderCreatorKardex(values) {
    this.setState({
        ...
        >
          <div key="sub_modal_container" style={styles.modalInBodyContainer}>
            ...
            <OrderCreatorKardex
              ...
              disabled={this.props.is_disabled}
              onError={this.onErrorOrderCreatorKardex}
              onChange={this.onChangeOrderCreatorKardex}
